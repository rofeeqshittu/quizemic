"""
Django settings for quizemic project.
...
SECRET_KEY = 'django-insecure-h^px^^p%qf&fkm2^+$71zg)d2m3#sazh^usvjh0z#%kc2_vs*k'
...
WSGI_APPLICATION = 'quizemic.wsgi.application'
